...
public class CreatedEvents {
	...
	public CreatedEvents() {
		/*
		 * Hier werden Ereignisse der Deutschen Geschichte aufgelistet
		 * Daten koennen jedoch in unterschiedliche Formate haben
		 * Bspw. als vollstaendiges Datum: 7.10.1949 Gruendung der DDR
		 * Oder Maerz 1848 Maerzrevolution in Deutschland
		 * Oder 1095 Erster Kreuzzug
		 * Oder als Zeitraum: 1618-1648 Dreißigjaehriger Krieg
		 */
		
		//hier wird die Klasse CreatedEvents definiert
		...
		eventList.add(new Event(1914, 1918, "Erster Weltkrieg"));//new Event benötigt als Parameter wie hier 3 Zahlen und einen String (=Zeichenkette)
		eventList.add(new Event("Maerz", 1848, "Märzrevolution in Deutschland"));//oder auch nur zwei Zahlen sowie einen String
		eventList.add(new Event(1095, "Erster Kreuzzug"));//oder auch nur eine Zahl sowie einen String
		eventList.add(new Event(18, 1, 1871, "Proklamation von Wilhelm I. zum deutschen Kaiser (Gründung des Zweiten Deutschen Reiches)"));
		...
		eventList.add(new Event(1618, 1648, "Dreißigjähriger Krieg"));
		eventList.add(new Event(1982, 1998, "Kanzlerschaft Kohls"));
		eventList.add(new Event(2005, 2021, "Kanzlerschaft Merkels"));
		eventList.add(new Event("Maerz", 1862, "Wilhelm I. ernennt Bismarck zum preußischen Ministerpräsidenten"));
		...
		eventList.add(new Event(23, 8, 1961, "Beginn des Baus der Berliner Mauer"));
		...
		//um ein Anfuehrungszeichen in einen String zu schreiben, muss davor ein Backslash gesetzt werden
		...
		eventList.add(new Event("Mai", 1863, "Gründung der SPD"));
		...
		eventList.add(new Event("August", 1936, "Olympische Spiele in Berlin"));
		eventList.add(new Event("Maerz", 1938, "\"Anschluss\" Österreichs an Hitler-Deutschland"));
